...
export default function RemindersWidgetEnhanced() {
  ...
  const getNextDueDate = (reminder: ReminderItem) => {
    const now = new Date();
    let nextDue: Date;

    switch (reminder.type) {
      case 'daily':
        nextDue = addDays(now, reminder.frequency);
        break;
      case 'weekly':
        nextDue = addWeeks(now, reminder.frequency);
        break;
      case 'monthly':
        nextDue = addMonths(now, reminder.frequency);
        break;
      case 'annual':
        nextDue = addYears(now, reminder.frequency);
        break;
      default:
